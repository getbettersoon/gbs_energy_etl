...
<p>The data I was looking for was regarding:
- energy production and consumption
- greenhouse emissions
- temperature</p>

<p>With all this data I wanted to create analytics tables to be able to answer questions like these:
- what countries are at the forefront of decreasing fossil fuel use and increasing renewable energy production?
- what are the effects of temperature on energy consumption?
- is there a correlation between GDP and amount of clean energy produced?
- in countries with least emissions per capita, what is a primary energy source?
- are there any poor countries which are among countries driving transformation to clean energy?</p>

I have found three datasets:</br>
...
- Columns:</br>
	...
	- drop column 'average temperature uncertainty'</br></br>

- Type constraints:</br>
	- datetime (dt) imported as 'object', it will have to be converted to numeric later</br>
	- temperature data imported as 'float64'</br></br>
...
- Type constraints:</br>
	...
	- What I have found is very few rows had across majority of their columns '#NUM!' value which was causing Pandas to import those columns as 'object'. To fix it I removed these rows.</br></br>

- Range constraints:</br>
	- for every combination of sector and gas, no value is higher than that for the entire world. Also no value is lower than 0.</br></br>

- Missing values:</br>
	- as mentioned in 'type constraints' above there were 5 rows, out of 4717 total rows, that had over 150 columns of data missing each, out of 174 total columns. Because all the missing data was concentrated in so few rows, I replaced all the values with np.nan and then removed those rows altogether.</br></br>
...
- Type constraints:</br>
	...
	- after flattening all columns containing numerical values were converted to float</br></br>
...
- Range constraints:</br>
	...
	- checked if there are any value below 0</br></br>
...
- Units:</br>
	- production and consumption figures in terawatt-hours</br></br>
...
At this stage I have considered suitable data model. Its purpose was to provide answers to analytical queries from data analysts. Data itself wasn't expected to change or be added more often than once a year. Therefore it wouldn't be used much to insert, update or delete data; it would be used to handle reads.</br> 
Total volume of data would be considered small. The model was expected to handle structured numeric and text data. And simple and easy to understand schema would be appreciated by end users.</br>
